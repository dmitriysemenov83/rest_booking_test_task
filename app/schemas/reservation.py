...
#     reservation_time: datetime = Field(..., example="2023-01-01T12:00:00")
#     duration_minutes: int = Field(..., gt=0, le=240, example=60)
#
#
# class ReservationCreate(ReservationBase):
#     @field_validator('reservation_time')
...
#     table_id: Optional[int] = Field(None, gt=0, example=1)
#     reservation_time: Optional[datetime] = Field(None, example="2023-01-01T12:00:00")
#     duration_minutes: Optional[int] = Field(None, gt=0, le=240, example=60)
#
#
# class Reservation(ReservationBase):
#     id: int
